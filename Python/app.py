...
def date_start(start):
    ...
    return (
        ...
        f"Minimum temperature: {round(date_temp[0][0], 1)} degF<br/>"
        f"Maximum temperature: {round(date_temp[0][1], 1)} degF<br/>"
        f"Average temperature: {round(date_temp[0][2], 1)} degF"
    )
